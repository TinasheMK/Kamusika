        ...
        if($request->hasfile('images'))
        {
           foreach($request->file('images') as $file)
           {
            ...
            if($request->image){
                ...
                Storage::delete("storage/uploads/".Auth::user()->id."/".$cover);
                Storage::delete("storage/uploads/".Auth::user()->id."/cache"."/".$cover);
            ...
            if($request->hasfile('images'))
            {
                ...
                if(!$images==NULL){
                    foreach ($images as $img){
                        Storage::delete("storage/uploads/".Auth::user()->id."/".$img);
                        Storage::delete("storage/uploads/".Auth::user()->id."/cache"."/".$img);
                    }
                }
                $product->more_imgs = json_encode($imgDatas);
